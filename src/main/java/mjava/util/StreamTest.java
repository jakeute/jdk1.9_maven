...
public class StreamTest {
     ...
     * toList toSet
     * toMap 当key相同时抛出异常，可以用 BinaryOperator进行处理
     * groupingBy() 生成map value是list集合
     *
     * <p>
    ...
    public void finalization() {
        ...
        strings.add("1");
        //语法糖
//        Map<String, String> collect = strings.stream().collect(Collectors.toMap(i -> i, i -> i, new BinaryOperator<String>() {
//            @Override
//            public String apply(String s, String s2) {
//                return s2;
//            }
//        }));
        Map<Object, List<String>> collect = strings.stream().collect(Collectors.groupingBy(new Function<String, Object>() {
            @Override
    ...
    int a = 9;
     ...
     void show() {
        Runnable r = new Runnable() {
            @Override
            public void run() {
                System.out.println(LamTest.this.getClass());
            }
        };
        r.run();

        r = () -> System.out.println(this.getClass());
        r.run();
    }
